...
for j in w:
    for i in alpha:
        ...
        dict_SVM = {'Window Length': j, 'Parameter': i, 'Sensitivity': sensitivity_SVM, 'Specificity': specificity_SVM,
                    'G-Mean': Gmean_SVM, 'Accuracy': score}
        ...
        dict_Weighted = {'Window Length': j, 'Parameter': i, 'Sensitivity': sensitivity_Weighted,
                         'Specificity': specificity_Weighted, 'G-Mean': Gmean_Weighted, 'Accuracy': score}
        ...
        # print(model.summary())
        model.fit(X_train, y_train, validation_data=(X_test, y_test), callbacks=[monitor, checkpointer], epochs=1000,
        ...
        dict_LSTM = {'Window Length': j, 'Parameter': i, 'Sensitivity': sensitivity_LSTM,
                     'Specificity': specificity_LSTM, 'G-Mean': Gmean_LSTM, 'Accuracy': score}
